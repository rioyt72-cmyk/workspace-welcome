       ...
       <div className="container mx-auto px-4 sm:px-6 lg:px-8">
         <div className="flex items-center justify-between h-16 lg:h-20">
           ...
           <div className="flex items-center gap-2">
             ...
             <span className="font-display font-bold text-xl text-foreground">CoWork</span>
           </div>
           ...
           <div className="hidden md:flex items-center gap-4">
             ...
             <Button variant="accent">Book a Tour</Button>
           </div>
         ...
         {isOpen && (
           <div className="md:hidden py-4 border-t border-border animate-fade-in">
             <div className="flex flex-col gap-4">
               <a href="#spaces" className="text-muted-foreground hover:text-foreground transition-colors py-2">Spaces</a>
