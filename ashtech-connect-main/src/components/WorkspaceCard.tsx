...
import { MapPin, Heart, ChevronLeft, ChevronRight, Clock, Train, ArrowRight } from "lucide-react";
...
export const WorkspaceCard = ({ workspace, onViewDetails, onBook }: WorkspaceCardProps) => {
